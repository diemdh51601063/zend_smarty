...
function content_61d253620b0366_40282928 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
...
?>
    ...
    <!-- jQuery Plugins -->
    <?php echo '<script'; ?>
 src="../../asset/user/js/jquery.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="../../asset/user/js/bootstrap.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="../../asset/user/js/slick.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="../../asset/user/js/nouislider.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="../../asset/user/js/jquery.zoom.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="../../asset/user/js/main.js"><?php echo '</script'; ?>
>
