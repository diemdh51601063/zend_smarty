<?php
/* Smarty version 4.0.0, created on 2022-01-20 03:22:58
  from 'C:\laragon\www\zend_smarty\application\smarty\templates\index\update.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_61e87322b527b1_99405921',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '137c763b879c20f55565c962c84dd09de584412c' => 
    array (
      0 => 'C:\\laragon\\www\\zend_smarty\\application\\smarty\\templates\\index\\update.tpl',
      1 => 1642623768,
      2 => 'file',
    ),
  ),
...
function content_61e87322b527b1_99405921 (Smarty_Internal_Template $_smarty_tpl) {
?><style>
...
<div class="container">
    <?php if (!empty($_smarty_tpl->tpl_vars['customer_info']->value)) {?>
        ...
        <form class="registration-container" method="post" id="formUpdateInfo" onsubmit="updateInfo(event)">
            <input class="input" type="hidden" id="customer_id" name="customer_id" value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['id'];?>
">
            <div class="form-group">
                <label>Họ:</label>
                <input class="input" type="text" id="first_name" name="first_name" placeholder="Họ" maxlength="50"
                    minlength="2" value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['first_name'];?>
" autocomplete="off">
            </div>
            <div class="form-group">
                <label>Tên:</label>
                <input class="input" type="text" id="last_name" name="last_name" placeholder="Tên" maxlength="50"
                    minlength="2" value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['last_name'];?>
" autocomplete="off">
            </div>
            <div class="form-group">
                <label>Email:</label>
                <input class="input" type="email" name="email" id="email" placeholder="Email" value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['email'];?>
"
                    autocomplete="off">
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    ...
                    <input class="input" type="phone" name="phone" id="phone" placeholder="Số điện thoại"
                        value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['phone'];?>
" autocomplete="off">
                </div>
            ...
            <div class="form-group">
                ...
                <input class="input" type="text" id="address" name="address" placeholder="Địa chỉ"
                    value="<?php echo $_smarty_tpl->tpl_vars['customer_info']->value['address'];?>
" autocomplete="off">
            </div>
...
<?php echo '<script'; ?>
>
    var city_code_input = <?php echo $_smarty_tpl->tpl_vars['customer_info']->value['city_code'];?>
;
    var district_code_input = <?php echo $_smarty_tpl->tpl_vars['customer_info']->value['district_code'];?>
;
    var ward_code_input = <?php echo $_smarty_tpl->tpl_vars['customer_info']->value['ward_code'];?>
;
